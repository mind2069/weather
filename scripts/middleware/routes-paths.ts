...
[
    ...
    { pattern: /^\/en-ca\/forecast\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: /^\/fr-ca\/prevision\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: "/en-ca/7-days", rewrite: "/forms/public/forecast" },
    { pattern: "/fr-ca/7-jours", rewrite: "/forms/public/forecast" },
    { pattern: /^\/en-ca\/7-days\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: /^\/fr-ca\/7-jours\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: "/en-ca/14-days", rewrite: "/forms/public/forecast" },
    { pattern: "/fr-ca/14-jours", rewrite: "/forms/public/forecast" },
    { pattern: /^\/en-ca\/14-days\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: /^\/fr-ca\/14-jours\/([^/]+)$/, rewrite: "/forms/public/forecast" },
];
