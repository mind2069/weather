...
[
    ...
    { pattern: /^\/en-ca\/forecast\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: /^\/fr-ca\/prevision\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: "/en-ca/7-day-forecast", rewrite: "/forms/public/forecast" },
    { pattern: "/fr-ca/previsions-7-jours", rewrite: "/forms/public/forecast" },
    { pattern: /^\/en-ca\/7-day-forecast\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: /^\/fr-ca\/previsions-7-jours\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: "/en-ca/14-day-forecast", rewrite: "/forms/public/forecast" },
    { pattern: "/fr-ca/previsions-14-jours", rewrite: "/forms/public/forecast" },
    { pattern: /^\/en-ca\/14-day-forecast\/([^/]+)$/, rewrite: "/forms/public/forecast" },
    { pattern: /^\/fr-ca\/previsions-14-jours\/([^/]+)$/, rewrite: "/forms/public/forecast" },
];
